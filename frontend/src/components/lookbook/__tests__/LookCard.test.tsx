...
const mockLook = {
  ...
  expand: {
    products: [
      {
        id: 'p1', name: 'Product 1', slug: 'p-1', price: 100,
        images: ['p1.jpg'], description: '', material: '', origin: '',
        sizes: [], available: true, featured: false,
      },
      {
        id: 'p2', name: 'Product 2', slug: 'p-2', price: 200,
        images: ['p2.jpg'], description: '', material: '', origin: '',
        sizes: [], available: true, featured: false,
      },
    ],
  },
...
describe('LookCard', () => {
  it('renders look title, garment count, and hero image', () => {
