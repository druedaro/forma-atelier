...
const mockLook = {
  ...
  expand: {
    products: [
      {
        id: 'p1', name: 'Test Product', slug: 'test-product', price: 99.99,
        images: ['img1.jpg'], description: '', material: '', origin: '',
        sizes: [], available: true, featured: false,
      },
    ],
  },
};
...
describe('ProductOverlay', () => {
  ...
  it('renders the look title and product details when a look is provided', () => {
  ...
  it('renders a close button that can be clicked', () => {
